    ...
    <>
      ...
      <Dialog open={showDialog} onOpenChange={setShowDialog}>
        <DialogContent className="max-w-sm text-center">
          <DialogHeader>
            <DialogTitle>Gói dịch vụ chỉ dành cho doanh nghiệp</DialogTitle>
            <DialogDescription>
              Vui lòng đăng ký tài khoản doanh nghiệp để mua gói dịch vụ này.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button onClick={() => handleRegisterCompany()} variant={"custom"}>
              Đăng ký ngay ➜{" "}
            </Button>
          </DialogFooter>
        </DialogContent>
