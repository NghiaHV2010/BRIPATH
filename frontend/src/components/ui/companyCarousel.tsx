    ...
    <div className="w-full bg-gradient-to-br from-green-50 to-emerald-50 py-8 mb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="embla overflow-hidden" ref={emblaRef}>
          <div className="embla__container flex">
            {featuredCompanies.map((company) => (
              <div
                key={company.id}
                className="embla__slide flex-[0_0_100%] min-w-0 pl-4 md:flex-[0_0_50%] lg:flex-[0_0_33.33%] xl:flex-[0_0_25%]"
              >
                <div className="bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-200 hover:border-green-200 p-6 h-full">
                  {/* Header với logo và rating */}
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                    ...
                    <button className="bg-green-600 text-white text-sm px-4 py-2 rounded-lg hover:bg-green-700 transition-colors font-medium">
                      Xem thêm
                    </button>
                  </div>
                </div>
        ...
        <div className="flex justify-center mt-6 space-x-2">
          {Array.from({ length: Math.ceil(featuredCompanies.length / 4) }).map(
            (_, index) => (
              <div
                key={index}
