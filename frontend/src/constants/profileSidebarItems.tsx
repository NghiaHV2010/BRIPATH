...
export const CompanyMenuItems: CompanyMenuItem[] = [
  ...
  { label: 'Quản lí sự kiện', icon: <BriefcaseBusiness className="w-4 h-4" />, href: '/profile/events' },
  ...
  { label: 'Theo dõi phản ánh', icon: <MessageSquareWarning className="w-4 h-4" />, href: '/profile/report' },
