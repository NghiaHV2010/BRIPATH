...
function App() {
  ...
  useEffect(() => {
    ...
    if (prevPathnameRef.current !== location.pathname) {
      console.log("✅ Scrolling to top - pathname changed");
      window.scrollTo(0, 0);
      prevPathnameRef.current = location.pathname;
    } else {
      console.log("❌ No scroll - same pathname");
    }
  }, [location.pathname]); // ✅ Only watch pathname changes (intentionally ignore search params)
