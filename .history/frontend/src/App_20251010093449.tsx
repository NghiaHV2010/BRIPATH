...
function App() {
  ...
  // Force scroll to top on app load/reload only
  useEffect(() => {
    // Override browser scroll restoration for single page app
    if ("scrollRestoration" in history) {
      history.scrollRestoration = "manual";
    }
    
    // Scroll to top on app initial load
    window.scrollTo(0, 0);
  }, []); // ✅ Empty deps = only on app mount
