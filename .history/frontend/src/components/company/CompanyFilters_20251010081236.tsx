      ...
      <form onSubmit={handleSubmit} className="max-w-2xl mx-auto">
        <div className="flex gap-3 mb-4">
          ...
          <button
            ...
            className="px-6 py-0.4 bg-blue-600 text-white rounded-xl font-semibold hover:bg-blue-700 transition-colors disabled:bg-slate-300"
          >
            {isLoading ? (
          ...
          >
            {isLoading ? (
              <Loader2 className="w-10 h-5 animate-spin mx-auto" />
            ) : (
              "Tìm kiếm"
            )}
          </Button>
