...
export default function CompanyCarousel({
  ...
  const infiniteCompanies = companies.length > 0 ? [...companies, ...companies, ...companies] : [];
      ...
      <CardContent className="p-6">
        ...
        <div className="relative overflow-hidden">
          <div
            ...
            style={{
              transform: `translateX(-${(currentIndex % companies.length) * (100 / itemsPerView + (itemsPerView > 1 ? 1 : 0))}%)`,
            }}
          >
